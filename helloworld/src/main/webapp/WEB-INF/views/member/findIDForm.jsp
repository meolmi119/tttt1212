...
<head>
<meta charset="UTF-8">
<link href="${contextPath}/resources/css/member/findIDForm.css" rel="stylesheet" type="text/css" media="screen">
...
<body>
 ...
 <div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <form action="${contextPath}/member/selectMember.do" method="post">
      <input type="text" id="mem_name" class="fadeIn second" name="mem_name" placeholder="이름">
    ...
    <div id="tab2-content">
    <form action="${contextPath}/business/selectMember.do" method="post">
      <input type="text" id="busi_name" class="fadeIn second" name="busi_name" placeholder="회사명">
      <input type="text" id="busi_email" class="fadeIn third" name="busi_email1" placeholder="이메일">
