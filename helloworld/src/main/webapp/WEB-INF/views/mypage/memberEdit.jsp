...
function selectBoxInit(){
 ...
 var mem_tel1='${memberInfo.mem_tel1 }';
...
<form class="memForm" name="frm_memForm">
  ...
  <fieldset>
    ...
    <input type="text" id="_mem_id" name="_mem_id" size="20" value="${memberInfo.mem_id}" disabled />
    <br>
    <label for="mem_pw">비밀번호:</label><br>
    <input id="mem_pw" name="mem_pw" type="password" minlength="8" maxlength="20" value="${memberInfo.mem_pw}"/>
    <input id="pw_edit" type="button" value="수정하기" onClick="fn_modify_member_info('mem_pw')" />
    <div id="pw-message"></div>	
    <label for="mem_name">이름:</label>
    <input id="mem_name" name="mem_name" type="text" value="${memberInfo.mem_name}" disabled />
    <br>
    <label for="mem_rrn">생년월일:</label>
    <input id="mem_rrn" name="mem_rrn" type="text" size="20" value="${memberInfo.mem_rrn}" disabled/>
    <br>
    <label for="mem_tel1">휴대폰번호:</label><br>
   		<select name="mem_tel1" id="mem_tel1">
			<option>없음</option>
			<option selected value="${memberInfo.mem_tel1}">${memberInfo.mem_tel1}</option>
			...
			<input size="10px" type="text" name="mem_tel2" id="mem_tel2" minlength="4" maxlength="4" pattern="[0-9]{4}" value="${memberInfo.mem_tel2}">
			<input size="10px" type="text" name="mem_tel3" id="mem_tel3" minlength="4" maxlength="4" pattern="[0-9]{4}" value="${memberInfo.mem_tel3}"> 
			<input id="tel_edit" type="button" value="수정하기" onClick="fn_modify_member_info('mem_tel')" />		
    <br>
    <label for="mem_email1">이메일:</label><br>
    <input id="mem_email1" type="text" name="mem_email1" value="${memberInfo.mem_email1}" disabled/>
	@ 
	<input id="mem_email2" type="text" name="mem_email2"  value="${memberInfo.mem_email2}" disabled/>
    <br>
    <label for="zipcode">주소:</label><br>
	<input type="text" id="zipcode" name="mem_zipcode" value="${memberInfo.mem_zipcode}">
	<a id="zipcode2" href="javascript:execDaumPostcode()">우편번호검색</a> <br>
	<label for="roadAddress">도로명 주소:</label><br>
	<input type="text" id="roadAddress" name="mem_roadAddress" value="${memberInfo.mem_roadAddress}"><br>
	<label for="jibunAddress">지번 주소:</label><br>
	<input type="text" id="jibunAddress" name="mem_jibunAddress" value="${memberInfo.mem_jibunAddress}"><br>
	<label for="namujiAddress">나머지 주소:</label><br>
	<input type="text" name="mem_namujiAddress" id="namujiAddress" value="${memberInfo.mem_namujiAddress}"/>								
  ...
  <input  type="hidden" name="h_tel1" value="${memberInfo.mem_tel1}" />
</body>
<script>
