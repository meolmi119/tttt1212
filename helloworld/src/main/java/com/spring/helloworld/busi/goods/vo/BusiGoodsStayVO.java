package com.spring.helloworld.busi.goods.vo;

import java.sql.Date;

import org.springframework.stereotype.Component;

@Component("BusiGoodsStayVO")
public class BusiGoodsStayVO {
	private String goods_stay_id;
	...
	private int goods_stay_room_number;
	...
	public String getGoods_stay_id() {
		return goods_stay_id;
	}
	public void setGoods_stay_id(String goods_stay_id) {
	...
	public int getGoods_stay_room_number() {
		return goods_stay_room_number;
	}
	public void setGoods_stay_room_number(int goods_stay_room_number) {
